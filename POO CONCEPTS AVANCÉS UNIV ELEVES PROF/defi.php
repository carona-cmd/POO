...
//
//Un professeur possède un prénom, un nom de famille et enseigne une matière :
// chaque professeur ne peut enseigner qu'une seule matière. Un élève possède un prénom,
// un nom de famille et une liste de matières qu'il souhaite suivre. Enfin, une matière est composée
// d'un titre et d'une description.
//
//Le résumé de chacun de ces éléments (professeur, élève ou matière) doit pouvoir être affiché sur le site
// Internet de l'université. Ce résumé sera simplement composé d'un titre de niveau 3 et d'une description,
// contenue dans une balise p.
//
//Le titre d'un étudiant est son nom suivi de son prénom, celui d'un professeur est similaire,
// mais préfixé de "Professeur" et celui d'une matière est simplement son titre.
//
//La description d'un étudiant est la liste de titres des matières qu'il étudie, celle d'un professeur
// est le nom de la matière qu'il enseigne, et celle d'une matière est simplement sa description.
//
