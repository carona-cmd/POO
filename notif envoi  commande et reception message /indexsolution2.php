...
require_once 'SMSIsReceived.php';
...
Implémentez la structure nécessaire à la mise en œuvre de ce système. Une méthode setReceived(bool $isReceived)
permettra de déclencher un changement d'état de cet objet.
